...
<head>
    <title>Chess Ratings</title>
    <link rel="icon" href="chess.png" type="image/x-icon">
...
<body>
        ...
        <form name="form2" action="" method="POST" enctype="multipart/form-data">
            <table class="table  table-striped text-center">
                <thead>
                    <tr>
                        <td colspan="7">
                            <h2 class="text-center text m-0" style="color: #85144b; text-align: center;">Chess Ratings&nbsp;<i style="color:black"></i>
                            </h2>
                        </td>
                    </tr>
                    <tr>
  ...
  -->
            ...
            <h2 style="color: #85144b;">Update Ratings</h2>
            ...
            <form name="form1" action="" method="POST" enctype="multipart/form-data">
                <table>
                    ...
                    <tr>
                        <th class="text-center">Classical</th>
                    ...
                    <tr>
                        <th class="text-center">Blitz</th>
                        <td><input type="number" name="blitz"></td>
                    </tr>
                    <tr>
                        <th class="text-center">Select Image file</th>
                    ...
                    <th class="text-center">Click to Upload </th>
